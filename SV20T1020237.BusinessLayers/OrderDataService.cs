...
namespace SV20T1020237.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        public static bool SaveAddressOrder(int orderID, string DeliveryProvince, string DeliveryAddress)

        {
            ...
            {
                return orderDB.SaveAddress(orderID, DeliveryAddress, DeliveryProvince);
            }
            return false;
        }
