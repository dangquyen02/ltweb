...
{
    public class CustomerDAL : _BaseDAL, ICommonDAL<Customer>   //CustomerDAL kế thừa _BaseDAL, cài đặt ICommonDAL vs kiểu dl là Customer
    {
        ...
        public int Count(string searchValue = "")
        {
            ...
            using(var connection = OpenConnection())
            {
                ...
                var parameters = new
                {
                    searchValue = searchValue ?? "",// tên tham số = giá trị truyền vào. Nếu searchValue = null thì thay thế chuỗi rỗng
                };
